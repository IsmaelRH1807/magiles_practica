...
public final class VentanaViaje extends javax.swing.JDialog {
    ...
    Archivos archivo;
    String indiceViaje;
    JFramePublicacion jfm;
    String cedula;

    Publicacion publicacion = new Publicacion();

    public void VerViaje(String nombre) {
        jLabel28.setText(nombre);
        jLabel5.setText(listaViaje.buscarViaje(indiceViaje).getOrigen());
        jLabel6.setText(listaViaje.buscarViaje(indiceViaje).getDestino());
        ...
        lblSalida.setText(listaViaje.buscarViaje(indiceViaje).getHoraSalida());
        lblLlegada.setText(listaViaje.buscarViaje(indiceViaje).getHoraLlegada());

    }

    public VentanaViaje(java.awt.Frame parent, boolean modal, ListaViaje listaViajes, String indiceViaje, JFramePublicacion jfm, String cedula, String nombre) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/epn/Imagenes/Anotación 2020-01-23 030344 (2).png"))); // NOI18N
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/epn/Imagenes/perfil (1).png"))); // NOI18N
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, -1, -1));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 90, 150, 40));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel18.setText("Vehículo:");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 150, 40));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel19.setText("Placa:");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 150, 40));
        ...
        jPanel1.add(lblLlegada, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, -1, -1));
        ...
        jPanel1.add(txtNumAsi, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, 80, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int precio = publicacion.PrecioTotal(listaViaje.buscarViaje(indiceViaje).getPrecio(), Integer.parseInt(this.txtNumAsi.getText()));
        ...
        if (listaViaje.buscarViaje(indiceViaje).getTotal_asientos_disponibles() >= Integer.parseInt(this.txtNumAsi.getText())) {
            if (JOptionPane.showConfirmDialog(null, "El precio total del viaje es de: $" + precio + "\n¿Continuar?\n", "Precio total", JOptionPane.YES_NO_OPTION) == 0) {
                if (Integer.parseInt(this.txtNumAsi.getText()) > 0) {
                    this.listaViaje.bajarDisponibilidad(indiceViaje, Integer.parseInt(this.txtNumAsi.getText()));
                    archivo.guardarArchivo(listaViaje);
                }
            }

        }else{if (Integer.parseInt(this.txtNumAsi.getText()) > 0) {
                    this.listaViaje.bajarDisponibilidad(indiceViaje, Integer.parseInt(this.txtNumAsi.getText()));
                    archivo.guardarArchivo(listaViaje);
                }
        }
